...
test('Live E2E: Login, Dashboard, Forensics, Geolocation, and Campaign Graph', async ({ page }) => {
  ...
  // 2. Click Auto-Fill Demo SOC Analyst
  const autoFillBtn = page.getByRole('button', { name: /Auto-Fill Demo SOC Analyst/i });
  ...
  // 7. Navigate to Campaign Graph page
